...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "/Patar-1/audio/gain -96, /input/input/channel.L 1, /input/input/channel.R 2, /input/source live, /output/record/file/type aiff, /output/audio/gain 0., /output/audio/mute 0, /output/limiter/active 1, /output/limiter/lookahead 64, /output/limiter/mode exponential, /output/limiter/postamp 0., /output/limiter/preamp 0., /output/limiter/release 300., /output/limiter/threshold -1., /output/record/samptype int24, /output/ch.1 1, /output/ch.2 2,"
				}
...
,
					"patching_rect" : [ 756.0, 197.0, 89.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 756.0, 161.0, 55.0, 24.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 756.0, 128.0, 38.0, 24.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 756.0, 94.0, 36.0, 24.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 756.0, 63.0, 112.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 756.0, 29.0, 72.0, 24.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 576.0, 225.5, 88.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 159.5, 130.0, 55.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 581.0, 71.5, 162.0, 55.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 756.0, 258.0, 70.0, 24.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", -1817, -128, -1075, 534, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
					"style" : "",
					"text" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 313.5, 300.0, 175.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 628.0, 455.5, 118.0, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 760.0, 225.5, 163.0, 24.0 ],
					"saved_object_attributes" : 					{
						"allwindowsactive" : 0,
						"audiosupport" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 628.0, 560.5, 42.0, 24.0 ],
					"style" : "",
					"text" : "+~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 628.0, 520.5, 49.0, 24.0 ],
					"style" : "",
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "k_MASOM_slave_walker_v1.02~.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, -3.5, 750.0, 455.0 ],
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 203.833328, 392.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "signal", "signal", "", "" ],
									"patching_rect" : [ 111.5, 169.0, 295.0, 24.0 ],
									"style" : "",
									"text" : "tatar_MASOM_slave_walker_v1.21~.model Patar-1"
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 298.0, 313.5, 300.0, 175.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"name" : "tatar_MASOM_slave_walker_v1.21~.model.maxpat",
				"bootpath" : "~/owncloud_westgrid/MAX/Libraries/libraryK/jamoma/tatar_MASOM/tatar_MASOM_slave_walker_v1.21",
				"patcherrelativepath" : "../../../../../owncloud_westgrid/MAX/Libraries/libraryK/jamoma/tatar_MASOM/tatar_MASOM_slave_walker_v1.21",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "checkArray.js",
				"bootpath" : "~/owncloud_westgrid/MAX/Libraries/libraryK/jamoma/old-k/k_MASOM_random_v1.01",
				"patcherrelativepath" : "../../../../../owncloud_westgrid/MAX/Libraries/libraryK/jamoma/old-k/k_MASOM_random_v1.01",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
				"name" : "k_MASOM_slave_walker_v1.02~.view.maxpat",
				"bootpath" : "~/owncloud_westgrid/MAX/Libraries/libraryK/jamoma/old-k/k_MASOM_slave_walker_v1.02",
				"patcherrelativepath" : "../../../../../owncloud_westgrid/MAX/Libraries/libraryK/jamoma/old-k/k_MASOM_slave_walker_v1.02",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
