...
,
		"rect" : [ -1838.0, -150.0, 1183.0, 596.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 691.0, 516.5, 49.0, 24.0 ],
					"style" : "",
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					"args" : [ "input-output-for-recording" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 650.5, 300.0, 175.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 941.0, 4.0, 51.0, 24.0 ],
					"style" : "",
					"text" : "j.model"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 941.0, 69.0, 67.0, 24.0 ],
					"style" : "",
					"text" : "pipe 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 941.0, 38.0, 63.0, 24.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 941.0, 103.0, 202.0, 258.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 941.0, 371.0, 42.0, 24.0 ],
					"style" : "",
					"text" : "j.send"
				}
...
,
					"patching_rect" : [ 767.0, 171.0, 89.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 767.0, 135.0, 55.0, 24.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 767.0, 102.0, 38.0, 24.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 767.0, 68.0, 36.0, 24.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 767.0, 37.0, 112.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 767.0, 3.0, 72.0, 24.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 587.0, 199.5, 88.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 133.5, 130.0, 55.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 576.0, 76.5, 162.0, 55.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 767.0, 232.0, 70.0, 24.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", -1838, -150, -655, 446, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
					"style" : "",
					"text" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 771.0, 525.5, 150.0, 84.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 771.0, 199.5, 163.0, 24.0 ],
					"saved_object_attributes" : 					{
						"allwindowsactive" : 0,
						"audiosupport" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 628.0, 555.5, 42.0, 24.0 ],
					"style" : "",
					"text" : "+~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 628.0, 516.5, 49.0, 24.0 ],
					"style" : "",
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "tatar_MASOM_v1.21~.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 181.833328, 392.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "signal", "signal", "", "" ],
									"patching_rect" : [ 111.5, 78.0, 230.0, 24.0 ],
									"style" : "",
									"text" : "tatar_MASOM_v1.21~.model REVIVE-1"
								}
...
,
					"patching_rect" : [ 628.0, 596.5, 97.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-26::obj-2::obj-47" : [ "Lookahead[3]", "Lookahead", 0 ],
			...
			"obj-26::obj-2::obj-12::obj-6" : [ "live.text[36]", "live.text", 0 ],
			"obj-10::obj-1::obj-12" : [ "Lookahead[2]", "Lookahead", 0 ],
			"obj-26::obj-2::obj-99" : [ "live.menu[7]", "live.menu[2]", 0 ],
			"obj-24::obj-127" : [ "number[2]", "number", 0 ],
			"obj-10::obj-108" : [ "live.text[31]", "live.text[4]", 0 ],
			"obj-26::obj-2::obj-111" : [ "live.numbox[6]", "live.numbox[2]", 0 ],
			"obj-10::obj-110" : [ "live.numbox[5]", "live.numbox[1]", 0 ],
			"obj-1::obj-2::obj-12::obj-42" : [ "live.text[1]", "live.text", 0 ],
			"obj-26::obj-2::obj-97" : [ "live.numbox[8]", "CPU", 0 ],
			...
			"obj-26::obj-2::obj-100" : [ "live.text[20]", "live.text[1]", 0 ],
			"obj-24::obj-82" : [ "live.text[12]", "live.text", 0 ],
			"obj-26::obj-2::obj-12::obj-13" : [ "Release[4]", "Release", 0 ],
			"obj-10::obj-1::obj-15" : [ "Postamp[1]", "Postamp", 0 ],
			"obj-22::obj-44::obj-237" : [ "number[1]", "number", 0 ],
			"obj-26::obj-2::obj-12::obj-30" : [ "live.menu[6]", "live.menu", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "k_output~.module.maxpat",
...
, 			{
				"name" : "tatar_MASOM_v1.21~.model.maxpat",
				"bootpath" : "~/owncloud_westgrid/MAX/Libraries/libraryK/jamoma/tatar_MASOM/tatar_MASOM_v1.21",
				"patcherrelativepath" : "../../../../../owncloud_westgrid/MAX/Libraries/libraryK/jamoma/tatar_MASOM/tatar_MASOM_v1.21",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
