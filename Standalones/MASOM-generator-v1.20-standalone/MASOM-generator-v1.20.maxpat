...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 668.0, 515.5, 49.0, 24.0 ],
					"style" : "",
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 766.0, 22.0, 51.0, 24.0 ],
					"style" : "",
					"text" : "j.model"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 802.0, 563.0, 45.0, 45.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 766.0, 227.0, 89.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 766.0, 191.0, 55.0, 24.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 766.0, 158.0, 38.0, 24.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 766.0, 124.0, 36.0, 24.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 766.0, 93.0, 112.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 766.0, 59.0, 72.0, 24.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 526.0, 246.0, 88.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 526.0, 181.0, 130.0, 55.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 526.0, 112.0, 162.0, 55.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 766.0, 288.0, 70.0, 24.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", -1726, -31, -661, 656, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
					"style" : "",
					"text" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 727.0, 461.0, 150.0, 84.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 607.0, 454.5, 114.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 770.0, 255.5, 163.0, 24.0 ],
					"saved_object_attributes" : 					{
						"allwindowsactive" : 0,
						"audiosupport" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 607.0, 554.5, 42.0, 24.0 ],
					"style" : "",
					"text" : "+~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 607.0, 515.5, 49.0, 24.0 ],
					"style" : "",
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 720.0, 602.5, 65.0, 24.0 ],
					"style" : "",
					"text" : "tapout~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 720.0, 559.5, 72.0, 24.0 ],
					"style" : "",
					"text" : "tapin~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "k_MASOM_generator_v1.01~.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "signal", "", "signal", "" ],
									"patching_rect" : [ 111.5, 158.0, 292.0, 24.0 ],
									"style" : "",
									"text" : "tatar_MASOM_generator_v1.20~.model REVIVE-1"
								}
...
,
					"patching_rect" : [ 607.0, 601.5, 97.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 298.0, 453.5, 300.0, 175.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"name" : "tatar_MASOM_generator_v1.20~.model.maxpat",
				"bootpath" : "~/owncloud_westgrid/MAX/Libraries/libraryK/jamoma/tatar_MASOM/tatar_MASOM_generator_v1.20",
				"patcherrelativepath" : "../../../../../owncloud_westgrid/MAX/Libraries/libraryK/jamoma/tatar_MASOM/tatar_MASOM_generator_v1.20",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "k_MASOM_generator_v1.01~.view.maxpat",
				"bootpath" : "~/owncloud_westgrid/MAX/Libraries/libraryK/jamoma/old-k/k_MASOM_generator_v1.01",
				"patcherrelativepath" : "../../../../../owncloud_westgrid/MAX/Libraries/libraryK/jamoma/old-k/k_MASOM_generator_v1.01",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
