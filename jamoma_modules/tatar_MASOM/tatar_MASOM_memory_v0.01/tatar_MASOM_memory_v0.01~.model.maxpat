...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1404.0, 1361.0, 186.0, 24.0 ],
					"style" : "",
					"text" : "j.message sample @type integer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1403.0, 1098.0, 426.0, 24.0 ],
					"style" : "",
					"text" : "j.parameter sample-set @type generic @description \"sample set of the node\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1168.0, 998.585022, 427.0, 24.0 ],
					"style" : "",
					"text" : "j.parameter selected-node @type integer @description \"selected SOM node\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 429.0, 154.079956, 351.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1614.5, 579.664978, 209.0, 24.0 ],
					"style" : "",
					"text" : "j.parameter SOM-dim @type integer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1403.0, 1037.084961, 192.0, 24.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 293.0, 166.0, 132.0, 38.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 460.149994, 143.0, 33.0, 24.0 ],
									"style" : "",
									"text" : "% 8"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 501.81665, 143.0, 29.5, 24.0 ],
									"style" : "",
									"text" : "/ 8"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 240.0, 81.0, 122.0, 40.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 77.650002, 130.0, 29.5, 24.0 ],
									"style" : "",
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 43.316669, 81.0, 122.0, 40.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0
									}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 446.0, 397.0, 116.0, 24.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"style" : "tatarism",
					"text" : "j.model @description \"MASOM:Musical Agent based on Self-organized Map - Memory Visualization\""
				}
