...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "k_MASOM_v1.03~.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 15.0, 392.0, 176.0, 24.0 ],
					"style" : "",
					"text" : "k_MASOM_v1.03~.model #1"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "k_MASOM_v1.03~.model.maxpat",
				"bootpath" : "~/owncloud_westgrid/max 6/Libraries/libraryK/jamoma/k_MASOM_v1.03",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
