...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1038.25, 1031.0, 73.0, 24.0 ],
					"style" : "",
					"text" : "sprintf %.3f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1218.0, 1019.0, 59.0, 24.0 ],
					"style" : "",
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 784.25, 978.0, 53.0, 24.0 ],
					"style" : "",
					"text" : "/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 238.5, 49.079956, 112.5, 25.0 ],
					"style" : "",
					"text" : "RANDOM",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 876.75, 949.0, 53.0, 24.0 ],
					"style" : "",
					"text" : "/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 336.25, 713.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 876.75, 996.0, 81.0, 24.0 ],
					"style" : "",
					"text" : "prepend size"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 841.0, 1111.420044, 80.0, 22.0 ],
					"style" : "",
					"text" : "Time passed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 929.75, 1102.420044, 26.0, 24.0 ],
					"style" : "",
					"text" : "0.",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 336.25, 770.920044, 97.0, 24.0 ],
					"style" : "",
					"text" : "j.remote sample"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 388.0, 806.420044, 49.0, 38.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.25, 815.420044, 50.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 3.0, 600.0, 315.0 ],
					"text" : "/Patar-1"
				}
