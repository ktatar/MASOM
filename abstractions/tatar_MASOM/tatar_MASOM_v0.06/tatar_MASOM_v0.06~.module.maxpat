...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "k_MASOM_v0.06~.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
,
		"dependency_cache" : [ 			{
				"name" : "k_MASOM_v0.06~.model.maxpat",
				"bootpath" : "~/owncloud_westgrid/max 6/Libraries/libraryK/jamoma/k_MASOM_v0.06",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
