...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 521.0, 50.0, 44.0, 44.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 544.75, 726.505066, 118.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 386.0, 96.0, 125.0, 22.0 ],
					"style" : "tatarism",
					"text" : "VOMM"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1180.0, 483.0, 82.0, 24.0 ],
					"style" : "",
					"text" : "j.remote start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 877.25, 862.920044, 143.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 336.25, 770.920044, 128.0, 24.0 ],
					"style" : "",
					"text" : "j.receive played-node"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 363.585022, 87.0, 24.0 ],
					"style" : "",
					"text" : "j.send polybuf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 322.0, 38.0, 24.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 455.0, 270.795044, 83.0, 40.25 ],
					"presentation" : 1,
					"presentation_rect" : [ 32.0, 96.0, 83.0, 40.25 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 387.0, 58.0, 87.0, 28.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					"activebgcolor" : [ 0.701961, 0.415686, 0.886275, 1.0 ],
					"activebgoncolor" : [ 0.372549, 0.196078, 0.486275, 1.0 ],
					"activetextoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontname" : "Futura Medium",
					"fontsize" : 9.0,
					"id" : "obj-77",
					...
					"presentation" : 1,
					"presentation_rect" : [ 386.0, 260.335022, 109.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"text" : "Random-feature-selector-off",
					"texton" : "Random-feature-selector-on",
					"varname" : "live.text"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 447.25, 219.375, 108.0, 38.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 386.0, 226.375, 50.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 369.5, 735.920044, 103.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 447.25, 175.335022, 94.0, 22.0 ],
					"style" : "",
					"text" : "Perceived node"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 447.25, 201.335022, 94.0, 22.0 ],
					"style" : "",
					"text" : "Played node"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1599.5, 572.0, 118.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 467.75, 139.335022, 78.0, 24.0 ],
					"style" : "tatarism",
					"text" : "Load Model"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 386.0, 139.335022, 78.0, 24.0 ],
					"style" : "tatarism",
					"text" : "Save Model"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-64",
					"items" : [ "Valence", ",", "Arousal", ",", "MFCC_1", ",", "MFCC_2", ",", "MFCC_3", ",", "MFCC_4", ",", "MFCC_5", ",", "MFCC_6", ",", "MFCC_7", ",", "MFCC_8", ",", "MFCC_9", ",", "MFCC_10", ",", "MFCC_11", ",", "MFCC_12", ",", "MFCC_13" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 386.0, 175.335022, 50.0, 24.0 ],
					"style" : "",
					"text" : "27",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 444.0, 116.255066, 69.0, 24.0 ],
					"style" : "",
					"text" : "printmodel"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 784.25, 836.920044, 76.0, 76.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 475.0, 50.0, 44.0, 44.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.25, 806.420044, 50.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 386.0, 201.335022, 50.0, 24.0 ],
					"style" : "",
					"text" : "27",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 386.0, 116.255066, 56.0, 24.0 ],
					"style" : "tatarism",
					"text" : "genstart"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 958.0, 605.505066, 160.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 128.0, 143.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "Arousal"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 139.335022, 60.0, 22.0 ],
					"style" : "",
					"text" : "Valence"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 67.0, 139.335022, 69.0, 30.0 ],
					"style" : "",
					"text" : "STATS"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-93" : [ "live.text[2]", "live.text[2]", 0 ],
			"obj-82" : [ "live.text[19]", "live.text", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "j.view.mxo",
