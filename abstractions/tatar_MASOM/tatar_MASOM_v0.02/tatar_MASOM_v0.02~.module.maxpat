...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "k_MASOM_v0.02~.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
,
		"dependency_cache" : [ 			{
				"name" : "k_MASOM_v0.02~.model.maxpat",
				"bootpath" : "~/owncloud_westgrid/max 6/Libraries/libraryK/jamoma/k_MASOM_v0.02",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "SOM_nodes.txt",
				"bootpath" : "~/ownCloud/VA/electronic_music/MASOM-2016-11-21/Corpora/self-distruption-album/data",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
