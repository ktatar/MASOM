...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "k_MASOM_v0.05~.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 14.0, 391.0, 176.0, 24.0 ],
					"style" : "",
					"text" : "k_MASOM_v0.05~.model #1"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "k_MASOM_v0.05~.model.maxpat",
				"bootpath" : "~/owncloud_westgrid/max 6/Libraries/libraryK/jamoma/k_MASOM_v0.05",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
