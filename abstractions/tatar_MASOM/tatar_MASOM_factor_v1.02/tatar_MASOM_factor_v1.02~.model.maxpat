...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 1204.0, 1673.0, 36.0, 24.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1419.0, 1843.0, 45.0, 24.0 ],
					"style" : "",
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1445.0, 1809.0, 83.0, 24.0 ],
					"style" : "",
					"text" : "prepend seek"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1144.0, 1643.0, 79.0, 24.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"mode" : "basic",
						"originallength" : [ 312135.34375, "ticks" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 1144.0, 1577.5, 42.0, 24.0 ],
					"style" : "",
					"text" : "t b b l"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 576.0, 70.0, 41.0, 24.0 ],
									"style" : "",
									"text" : "dump"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 91.0, 189.0, 504.0, 24.0 ],
									"style" : "",
									"text" : "zsa.dist"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 91.0, 229.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 1144.0, 1781.0, 81.0, 24.0 ],
					"style" : "tatarism",
					"text" : "j.out~ 1"
				}
